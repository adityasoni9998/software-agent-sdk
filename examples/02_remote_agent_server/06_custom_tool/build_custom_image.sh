...
#          (default: docker.io/adityasoni8/codescout-agent-server-sail-workspace)
#   CUSTOM_TAG: Tag component used by the SDK docker builder
#               (default: codescout-sail)
...
IMAGE="docker.io/adityasoni8/codescout-agent-server-sail-workspace"
CUSTOM_TAG="codescout-sail"
PUSH=0
